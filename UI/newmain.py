...
class Ui_MainWindow(object):
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.fun1.setText(_translate("MainWindow", "常规自动化投放"))
        self.fun2.setText(_translate("MainWindow", "常规智能化投放"))
        self.fun3.setText(_translate("MainWindow", "智能化新品选点"))
        ...
        self.fun3_2.setText(_translate("MainWindow", "智能化补货替代"))
